...
if __name__ == "__main__" : 
	...
	gui.geometry("525x560")

	# Create a Date Of Birth : label 
	dob = Label(gui, text = "Date Of Birth", fg = "black",bg="powder blue")

	# Create a Given Date : label
	givenDate = Label(gui, text = "Given Date", fg = "black",bg="powder blue")

	# Create a Day : label
	day = Label(gui, text = "Day", fg = "black",bg="powder blue")

	# Create a Month : label
	month = Label(gui, text = "Month", fg = "black",bg="powder blue")

	# Create a Year : label
	year = Label(gui, text = "Year", fg = "black",bg="powder blue")

	# Create a Given Day : label
	givenDay = Label(gui, text = "Given Day", fg = "black",bg="powder blue")

	# Create a Given Month : label
	givenMonth = Label(gui, text = "Given Month", fg = "black",bg="powder blue")

	# Create a Given Year : label
	givenYear = Label(gui, text = "Given Year", fg = "black",bg="powder blue")

	# Create a Years : label
	rsltYear = Label(gui, text = "Years",fg = "black",bg="powder blue")

	# Create a Months : label
	rsltMonth = Label(gui, text = "Months", fg = "black",bg="powder blue")

	# Create a Days : label
	rsltDay = Label(gui, text = "Days", fg = "black",bg="powder blue")
